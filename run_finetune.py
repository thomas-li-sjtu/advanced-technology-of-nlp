...
parser.add_argument('--num_train_epochs', type=int, help='训练epoch数', default=5)
...
parser.add_argument('--learning_rate', type=float, help='学习率', default=1e-5)
...
parser.add_argument('--tar_name_prefix', type=str, help='最终模型打包名称', default='oppo_finetune_bert')
...
def compute_metrics_v2(eval_pred):
    logits, labels = eval_pred
    predictions = logits.predictions.argmax(-1)
